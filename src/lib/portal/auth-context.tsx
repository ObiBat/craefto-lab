...
interface AuthContextValue {
  ...
  loading: boolean;
  /** @deprecated Always false. Kept for backward compatibility with page components. */
  isDemo: boolean;
  ...
  /** @deprecated No-op. Demo mode removed in Portal v2. */
...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const switchDemoRole = useCallback((_role: UserRole) => {}, []);
  ...
  const contextValue = useMemo<AuthContextValue>(
    ...
    [user, portalUser, session, loading, refreshPortalUser, hasPermission, switchDemoRole],
  );
