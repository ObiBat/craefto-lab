...
export function SubscriptionWelcomeEmail({ unsubscribeUrl }: SubscriptionWelcomeEmailProps) {
  return `
<!DOCTYPE html>
<html lang="en">
<head>
          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <p style="margin: 0 0 20px; font-size: 16px; color: #6B6B6B; line-height: 1.6;">
                Your subscription is now confirmed. You'll receive our latest articles on design systems, applied AI, and creative technology.
              </p>
              ...
              <div style="margin: 30px 0; padding: 24px; background-color: #FAF7F2; border-radius: 8px;">
                <p style="margin: 0; font-size: 14px; color: #6B6B6B; line-height: 1.6;">
                  <strong style="color: #4A4A4A;">What to expect:</strong><br><br>
                  Thoughtful articles on building digital products, not spam. We only send when we have something worth sharing.
                </p>
              </div>
