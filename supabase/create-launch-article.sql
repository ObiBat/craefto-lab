...
SELECT
  'February 1st: The Official Launch of Craefto.com',
  'february-1st-official-launch-craefto',
  'After months of meticulous planning and development, we are ready to introduce Craefto to the world.',
  'On February 1st, 2026, Craefto.com goes live. This is not just a website launch—it is the culmination of our vision for a design and technology studio that puts craft at the centre of everything we build.',
  E'# February 1st: The Official Launch of Craefto.com

After months of meticulous planning, countless iterations, and an unwavering commitment to craft, we are thrilled to announce that **Craefto.com will officially launch on February 1st, 2026**.
...
Our Journal is not a blog filled with generic content. It is a curated collection of insights on:

- Systems thinking and design architectures
- Applied AI that solves real problems
- Product craft and user experience excellence
...
If you are a founder who refuses to settle for mediocre digital products, a designer who believes in systems over shortcuts, or an engineer who values elegance as much as functionality—we built Craefto for you.

We invite you to visit Craefto.com on February 1st. Explore what we have created. Read our thinking. And if our approach resonates with yours, let us talk about what we might build together.
...
SELECT 
  a.id,
  p.id,
  CASE WHEN p.slug = 'craefto-practice' THEN TRUE ELSE FALSE END,
  CASE p.slug
    WHEN 'craefto-practice' THEN 0
    WHEN 'design' THEN 1
    ELSE 2
  END
FROM journal_articles a
CROSS JOIN journal_pillars p
WHERE a.slug = 'february-1st-official-launch-craefto'
  AND p.slug IN ('craefto-practice', 'design')
